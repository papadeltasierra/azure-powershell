...
Update-AzConnectedKubernetes -ClusterName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-DistributionVersion <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-ConnectionType <String>]
 [-GatewayResoureceId <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-AzConnectedKubernetes -InputObject <IConnectedKubernetesIdentity> [-AcceptEULA]
 ...
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-ConnectionType <String>] [-GatewayResoureceId <String>]
