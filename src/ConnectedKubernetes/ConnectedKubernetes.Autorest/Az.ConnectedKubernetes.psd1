@{
  ...
  FunctionsToExport = 'Get-AzConnectedKubernetes', 'Get-AzConnectedKubernetesUserCredential', 'Get-ConfigDpEndpoint', 'Get-HelmValues', 'New-AzConnectedKubernetes', 'Remove-AzConnectedKubernetes', 'Update-AzConnectedKubernetes', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
